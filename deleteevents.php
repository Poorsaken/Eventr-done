...
?>
    ...
    <!DOCTYPE html>
        ...
        <div class="parent_container">
            ...
            $DB->connectDB();
            $obj = new Profile();
            $products = $obj->GetAllEventsLNG();

             if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['delete_product_id'])) {
                            $obj->DeletedEvents($_POST['delete_product_id']);
                }
  ...
  echo "<form method='POST' action=''>";
                ...
                echo "<input type='submit' class='reject-button' value='DELETE' style='padding: 5px 10px; color: red; cursor: pointer;'>";
