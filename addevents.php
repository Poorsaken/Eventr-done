        ...
        <div class="left-container">
            <?php 
                ...
                if (isset($_POST['btn']) && isset($_POST['csrf_token']) && $_POST['csrf_token'] === $_SESSION['csrf_token']) {
                    ...
                    echo '<script>setTimeout(function(){window.location.href="addevents.php";}, 1000);</script>';
                }
            ?>
        </div>
                    ...
                    <div class="parent-flex">
                        ...
                        <div class="venue_host" style="display: flex;">
                            ...
                            <div class="host">
                                ...
                                <input type="text" name="username" required value="<?php echo htmlspecialchars($_SESSION['username']); ?>"><br/>
                            </div>
                        </div>
