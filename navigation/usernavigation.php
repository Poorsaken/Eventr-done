...
<div class="parents">
    ...
    <div class="navlinks" id="active-events">
        ...
        <div class="nav_title">
            <a onclick="UserActiveEvents(); setActiveNavLink('active-events')">Active Events</a>
        </div>
    </div>
    ...
    <div class="navlinks" id="cancelled-events">
        ...
        <div class="nav_title">
            <a onclick="UserCancelledEvents(); setActiveNavLink('cancelled-events')">Cancelled Events</a>
        </div>
    </div>
    ...
    <div class="navlinks" id="add-event">
        ...
        <div class="nav_title">
            <a onclick="UserAddEvents(); setActiveNavLink('add-event')">Add Event</a>
        </div>
    </div>
