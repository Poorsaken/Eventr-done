        ...
        <div class="card-container">
            ...
            if ($products) {
                ...
                foreach ($products as $product) {
                    ...
                    echo "<form method='POST' action='update_eventform.php'>";
                    echo "<input type='hidden' name='update_product_id' value='{$product['id']}'>";
                    echo "<input type='submit' class='reject-button' value='UPDATE' style='padding: 5px 10px;'>";
                    echo "</form>";
